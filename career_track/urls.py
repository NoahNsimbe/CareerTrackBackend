...
urlpatterns = [
    ...
    path('api/admin/login/', auth_views.LoginView.as_view(), name='admin_login'),
    path('api/admin/password_reset/', auth_views.PasswordResetView.as_view(), name='admin_password_reset'),
    path('api/admin/password_reset/done/', auth_views.PasswordResetDoneView.as_view(), name='password_reset_done'),
